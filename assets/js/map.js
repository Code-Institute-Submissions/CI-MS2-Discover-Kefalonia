...
var towns = [
    ...
    trees and is ideal for couples who seek downtime to rest, relax, and recuperate on a romantic getaway, purposefully seeking a place without any nightlife.", "<img src='assets/img/towns/town-assos.jpg' alt='Assos'>", " "],
    ...
    daily life. Modern as well as traditional cafes, bars, and tavernas can be found on the harbour where the fishermen still unload their catch of the day.", "<img src='assets/img/towns/town-sami.jpg' alt='Sami'>", " "],
    ...
    lovely port where fishing and excursion boats moor. Those with access to a boat should definitely explore its pristine isolated beaches and stunning coves.", "<img src='assets/img/towns/town-agia.jpg' alt='Agia Efimia'>", " "],
...
var active = [
    [38.12273, 20.61336, "Sea Kayaking Kefalonia", "Run by Yvonne and Pavlos, Sea Kayaking Kefalonia is a sea kayaking outfitter who organize day and multi-day kayak trips as well as \
    sea kayak courses in the crystal clear and warm mediterranean waters of the Ionian.", "<img src='assets/img/active/active-kayak.jpg' alt='Sea kayaking'>", "<a href='http://www.seakayakingkefalonia-greece.com/index.html' target='_blank'>Visit Sea Kayaking Kefalonia</a>"],
    [38.16252, 20.59040, "Robola Winery", "In the heart of the Robola Viticulture Zone, dozens of viticulturists from Omala and the surrounding areas (Troiannata, Vlachata, Mousata, \
    Faraklata, Dilinata) created in 1982 the Agricultural Wine Cooperative of Producers of Robola Kefallinia but to try to protect Kefalonian vineyard.", "<img src='assets/img/active/robola.jpg' alt='Robola Wine'>", "<a href='https://www.orealios.gr/en/' target='_blank'>Visit Robola Growers Co-operative</a>"],
    ...
    Paragliding | Jeep Safari's", "<img src='assets/img/active/active-para.jpg' alt='Paragliding'>", "<a href='https://wildnature-expeditions.gr/' target='_blank'>Visit Wild Nature Expeditions</a>"],
    ...
    holding a breathtaking sunlit lake. The waters which feed this natural wonder travel through the rocks all of the way from Argostoli", "<img src='assets/img/active/melis-cave.jpg' alt='Melissani Cave'>",  "<a href='https://www.melissani-cave.com/' target='_blank'>Visit Melissani Cave</a>"],
    [38.21405, 20.64759, "Bavarian Horse Riding","Enjoy the mountains, canyons, valleys, olive groves and the virgin nature of Kefalonia on horseback. We'll show you all these\
     places on our sturdy, sure-footed and well trained Haflingers and Bavarian warm blood horses.", "<img src='assets/img/active/active-horse.jpg' alt='Bavarian horse riding'>", "<a href='https://www.kephalonia.com/' target='_blank'>Visit Bavarian Horse Riding Stable</a>"]
];
