...
var beaches = [
    ...
    [38.471623, 20.562531, "Kimilia", "Kimilia Beach is set in a small cove near Fiskardo with crystal waters backed by cypress trees it's consider as one of the most beautiful small beaches in Cephalonia and was once a well kept secret and the refuge of locals during the busiest summer months."],
    [38.466161, 20.573059, "Emplisi", "Emplisi lies in a very beautiful bay with crystal clear blue-green water a few kilometres from Fiskardo. The beach consists of white pebbles. If you like to snorkel, you can do it among the rocks. The water that surrounds Emplisi are among the clearest on the whole island"],
    ...
    [38.452562, 20.576679, "Foki", "Foki beach is a beautiful inlet just south of Fiskardo. This is a small beach with white pebbles surrounded by olive trees, which  offer some natural shade and there are some interesting caves and coves on the right side of the beach to explore. It’s definitely one of the more picturesque beaches in Kefalonia so remember to bring your camera with you."],
    [38.16058, 20.41527, "Xi", "This 3km Blue Flag beauty is accessorised with striking red sands and white clay cliffs. Xi's answer to a free spa treatment, the natural clays offer an all-over body mask while you sunbathe. A fantastic, family-friendly option for a day spent on the sand, the warm shallows invite little water babies to splash around safely."]
];
